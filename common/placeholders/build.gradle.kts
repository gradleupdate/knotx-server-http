...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            artifactId = "knotx-server-http-common-placeholders"
            from(components["java"])
            artifact(tasks["sourcesJar"])
            artifact(tasks["javadocJar"])
            pom {
                name.set("Knot.x HTTP Server Common Placeholders")
                description.set("HTTP Server Placeholders Substitutor helper")
